...
<div class="share">
	...
	<div class="social">
  <a class="socialIcon" href="javascript:void(0);" onClick="javascript:fm_invite_facebookshare( '<?php print fm_invite_get_invite_url();?>', '<?php print drupal_get_path("theme","fadmashion_commerce") . '/images/fb/fb-sequin-closeup.png'; ?>');"><img width="25" src="/<?php print drupal_get_path("theme","fadmashion_commerce");?>/images/icon_facebook_white.jpg"></a>
