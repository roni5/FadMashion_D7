...
<div class="share">
  ...
  <a class="socialIcon" href="target="_blank" href="<?php print theme('fm_invite_twitter_text', '')?>"><img src="/<?php print drupal_get_path("theme","fadmashion_commerce");?>/images/icon_twitter_white.jpg"></a>
  <?php 
