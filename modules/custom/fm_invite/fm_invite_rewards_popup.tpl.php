...
<div class="share">
  ...
  <a class="socialIcon" target="_blank" href="http://twitter.com/home?status=<?php print theme('fm_invite_twitter_text' , ''); ?>"><img src="/<?php print drupal_get_path("theme","fadmashion_commerce");?>/images/icon_twitter_white.jpg"></a>
  <?php 
