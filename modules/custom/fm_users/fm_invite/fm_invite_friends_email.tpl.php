...
<tr>
<td colspan="2" style="color: #fff; font-size: 18px;"><img src="<?php print pp()?>emails/template2/header.jpg" alt="Fadmashion" style="border: none; display: block;"></td>
</tr>
<tr>
...
<img src="<?php print pp();?>emails/b_left.jpg" class="buttonEdge" style="border:none;display:block;float:left;"><a href="<?php print $reg_code_url;?>" class="button" style="color:#fff;height:54px;font-size:19px;line-height:54px;padding:0 20px;background:#937c72;text-decoration:none;float:left;">Open Invitation</a><img src="<?php print pp()?>emails/b_right.jpg" class="buttonEdge" style="border:none;display:block;float:left;">
</div>
...
<div class="quote" style='padding: 80px 0 0 0; color: #796155; font-family:Georgia, "Times New Roman", Times, serif; font-style:italic; font-size: 13px; line-height: 20px;'>
 ...
 <img src="<?php print pp();?>emails/myfashionlife.jpg" alt="-myfashionlife" align="right" style="display:block;margin-top:14px;border:none;">
</div>
...
<td width="237"><img src="<?php print pp();?>emails/template2/model.jpg" style="border: none; display: block;"></td>
</tr>
<tr>
<td colspan="2"><img src="<?php print pp();?>template2/footer.jpg" style="border: none; display: block;"></td>
