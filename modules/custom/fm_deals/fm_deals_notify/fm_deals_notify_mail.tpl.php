...
<p style="margin-bottom: 10px; margin-top: 10px; font-size: 14px; line-height: 18px; ">This is a reminder that in 15 minutes, the deal you were interested in on Fadmashion will start. Check out the <?php print l('preview page', 'node/' . $nid, array('absolute' => true));?> and get ready to shop!</p>
