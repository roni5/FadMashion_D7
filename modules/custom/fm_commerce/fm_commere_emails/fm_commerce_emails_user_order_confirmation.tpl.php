...
<p style="margin-bottom: 10px; font-size: 14px; line-height: 18px; margin-top: 0;"> <?php print l('Login to your Fadmashion account', '', array('absolute' => true, 'query' => array('login' => 1) ));?> to review your purchase confirmation. Thanks for shopping with us and for supporting independent fashion!</p>
