	...
	$.supersized({
		...
		slides 					:  	[		//Slideshow Images
											{//Slide 1
											  ...
											  title: 'Designer: <a style="colorbox-load" style="font-style: normal; font-family:\'museo-sans-1\',\'museo-sans-2\',Helvetica;" href="http://www.daniellakallmeyer.com/?width=600&height=400&iframe=true"> Daniella Kallmeyer</a>'
											},	

											{//Slide 2
												image : '/<?php print drupal_get_path("theme","fadmashion_commerce");?>/images/front-page/splash_photo.jpg',
                        title: 'Designer: <a style="colorbox-load" href="http://www.jonathansimkhai.com/jonathan.html/?width=600&height=400&iframe=true" style="font-style: normal; font-family:\'museo-sans-1\',\'museo-sans-2\',Helvetica;" >Jonathan Simkhai</a>'
											}	  
									]
	}); 
});
