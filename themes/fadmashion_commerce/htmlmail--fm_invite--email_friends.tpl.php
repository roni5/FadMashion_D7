...
<tr>
<td colspan="2" style="color: #fff; font-size: 18px;"><img src="<?php print $theme_url?>/images/template2/header.jpg" alt="Fadmashion" style="border: none; display: block;"></td>
</tr>
<tr>
...
<td width="237"><img src="<?php print $theme_url?>/images/template2/model.jpg" style="border: none; display: block;"></td>
</tr>
<tr>
<td colspan="2"><img src="h<?php print $theme_url?>/images/template2/footer.jpg" style="border: none; display: block;"></td>
