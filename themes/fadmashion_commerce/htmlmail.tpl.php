...
<td class="header" style="padding: 30px 0 10px 0;"><img alt="Fadmashion.com | Choose Independent Fashion" title="Fadmashion.com | Choose Independent Fashion" src="<?php print $theme_url;?>/images/logo_black.jpg"></td>
</tr>
<tr>
<td class="headerSide">&nbsp;</td>
</tr>
