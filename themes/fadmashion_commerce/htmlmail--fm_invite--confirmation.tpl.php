...
<a target="_blank" href="http://twitter.com/home?status=<?php print fm_invite_twitter_text($body);?>" class="socialIcon" style="color: #01517e; text-decoration:none;"><img src="http://www.owenlinton.com/fadmashion/dev/email1b/icon_twitter.jpg" align="absmiddle" style="margin: 0 5px 0 0; display: inline; border: medium none;"></a>
<input type="text" value="<?php print $body; ?>" id="share_url" onclick="this.select()" class="form-text-readonly" autocomplete="off" style="width: 240px; border: 1px solid #c5bdb6; color: #72655c;  margin: 0 0 0 5px; padding: 2px 0 0 2px ;height: 22px;" name="share_url" readonly>
</div>
