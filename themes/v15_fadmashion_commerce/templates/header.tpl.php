  ...
  <div class="right">
    ...
    <div class="nav">
      <ul>
        ...
        <li class="<?php arg(0) == 'shop' ? print 'active' : ''?>"><?php print l('Shop', 'shop', array('attributes' => array('class' => array('tooltipBtn') )));?></li>
         <div class="tooltip">
            <div class="pad">
              <div class="column">
