...
<meta content="b51f8eff8c1589d4a75797ee56a93d01202eccd2" name="csrf-token" />
  ...
  <body class="logged_out page-blob windows env-production">
    ...
    <ul class="actions">
        ...
        <li>
            ...
            <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch watch-button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'b51f8eff8c1589d4a75797ee56a93d01202eccd2'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Watch</span></a>
  ...
  <ul class="tabs">
    ...
    <li><a href="/douglascrockford/JSON-js/pulls" highlight="repo_pulls">Pull Requests (1)</a></li>

    

    
      
      <li><a href="/douglascrockford/JSON-js/issues" highlight="issues">Issues (1)</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      <div id="repo_details_loader" class="metabox-loader" style="display:none">Sending Request&hellip;</div>
        ...
        <a href="/douglascrockford/JSON-js/downloads" class="download-source" data-facebox-url="/douglascrockford/JSON-js/archives/master" id="download_button" title="Download source, tagged packages and binaries."><span class="icon"></span>Downloads</a>
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="b51f8eff8c1589d4a75797ee56a93d01202eccd2" /></div>
  ...
  <ul class="clone-urls">
      ...
      <li class="http_clone_url"><a href="https://github.com/douglascrockford/JSON-js.git" data-permissions="Read-Only">HTTP</a></li>
      <li class="public_clone_url"><a href="git://github.com/douglascrockford/JSON-js.git" data-permissions="Read-Only">Git Read-Only</a></li>
    
    
  </ul>
  <input type="text" spellcheck="false" class="url-field" />
        <span style="display:none" id="clippy_1491" class="clippy-text"></span>
      <span id="clippy_tooltip_clippy_1491" class="clippy-tooltip tooltipped" title="copy to clipboard">
      ...
      <param NAME="FlashVars" value="id=clippy_1491&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_1491&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
  ...
  <p class="url-description"><strong>Read+Write</strong> access</p>
    ...
    <div class="frame frame-center tree-finder" style="display:none" data-tree-list-url="/douglascrockford/JSON-js/tree-list/7a18252d0ec1b46b26afb933f65434dc1f7844f5" data-blob-url-prefix="/douglascrockford/JSON-js/blob/7a18252d0ec1b46b26afb933f65434dc1f7844f5">
  ...
  <p class="commit-title ">
      ...
      <a href="/douglascrockford/JSON-js/commit/7a18252d0ec1b46b26afb933f65434dc1f7844f5">[\d+]</a>
 ...
 <div class="lower_footer">
  <div class="site" class="clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2011 <span id="_rrt" title="0.05876s from fe8.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
